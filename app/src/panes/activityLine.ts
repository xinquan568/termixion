...
// trmx-247: the wire payload type + its parser live in `ipc/payloads` (transport).
import type { ActivityMeta } from "../ipc/payloads";
export type { ActivityMeta } from "../ipc/payloads";
export { parseActivityPayload } from "../ipc/payloads";
