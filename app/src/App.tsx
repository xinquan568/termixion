...
// trmx-51: Settings moved to its own window (see main.tsx's surface routing); the main window
// mounts the headless UpdateAuthorityHost instead — it owns automatic update checks and serves the
// settings window over the event bus.
